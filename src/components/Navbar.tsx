            ...
            <ul className="flex items-center text-white justify-between">
              ...
              <li>
                ...
                >
                  <div className="block lg:inline-block">
                    <svg
                      className=" w-5 h-5  mx-auto fill-current text-black lg:text-white "
                      xmlns="http://www.w3.org/2000/svg"
                      width="22.34"
                      height="22.34"
              ...
              <li>
                ...
                >
                  <div className="block lg:inline-block">
                    <svg
                      className=" w-5 h-5  mx-auto stroke-current fill-current text-black lg:text-white "
                      xmlns="http://www.w3.org/2000/svg"
                      width="22.54"
                      height="22.59"
                      viewBox="0 0 22.54 22.59"
                    >
                      <g
                        id="Layer_1"
                        data-name="Layer 1"
                      ...
                      >
                        ...
                        <path
                          ...
                          d="M11.33,6.17a5.16,5.16,0,1,0,5.15,5.16,5.16,5.16,0,0,0-5.15-5.16Zm0,9.45a4.3,4.3,0,1,1,4.29-4.29h0a4.31,4.31,0,0,1-4.29,4.29Z"
                          fill="currentColor"
                          stroke="currentColor"
                          stroke-miterlimit="10"
                          stroke-width="0.3"
