            ...
            <ul className="flex items-center text-white space-x-10 ">
              <li>
                ...
                >
                  ...
                  <div className=" block lg:inline-block px-1 lg:px-3 text-xs sm:text-lg md:text-lg font-light">Dashboard</div>
                </a>
              </li>
              ...
              <li>
                ...
                >
                  ...
                  <div className=" block lg:inline-block px-1 lg:px-3 text-xs sm:text-lg md:text-lg font-light">Profile</div>
                </a>
              </li>
              ...
              <li>
                ...
                >
                  ...
                  <div className=" block lg:inline-block px-1 lg:px-3 text-xs sm:text-lg md:text-lg font-light">Marketing</div>
                </a>
              </li>
