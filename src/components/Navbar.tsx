          ...
          <div className="">
            <ul className="flex items-center text-white justify-between">
              <li>
                ...
                >
                  <div className="block lg:inline-block">
                    <svg className=" w-5 h-5  mx-auto stroke-current text-black lg:text-white " xmlns="http://www.w3.org/2000/svg" width="22.581" height="22.394" viewBox="0 0 22.581 22.394">
                  ...
                  <div className=" block lg:inline-block px-1 py-1 lg:px-3 text-xs sm:text-lg md:text-lg font-light">Dashboard</div>
                </a>
              </li>
              ...
              <li>
                ...
                >
                  <div className="block lg:inline-block">
                    <svg className=" w-5 h-5  mx-auto fill-current text-black lg:text-white " xmlns="http://www.w3.org/2000/svg" width="22.34" height="22.34" viewBox="0 0 22.34 22.34">
                  ...
                  <div className=" block lg:inline-block px-1 py-1 lg:px-3 text-xs sm:text-lg md:text-lg font-light">Profile</div>
                </a>
              </li>
              ...
              <li>
                ...
                >
                  <div className="block lg:inline-block">
                    <svg className=" w-5 h-5  mx-auto stroke-current text-black lg:text-white " xmlns="http://www.w3.org/2000/svg" width="23.331" height="23.366" viewBox="0 0 23.331 23.366">
                  ...
                  <div className=" block lg:inline-block px-1 py-1 lg:px-3 text-xs sm:text-lg md:text-lg font-light">Marketing</div>
                </a>
              </li>
              ...
              <li>
                ...
                >
                  <div className="block lg:inline-block">
                    <svg className=" w-5 h-5  mx-auto stroke-current text-black lg:text-white " xmlns="http://www.w3.org/2000/svg" width="22.573" height="17.591" viewBox="0 0 22.573 17.591">
                  ...
                  <div className=" block lg:inline-block px-1 py-1 lg:px-3 text-xs sm:text-lg md:text-lg font-light">Website</div>
                </a>
              </li>
              ...
              <li>
                ...
                >
                  <div className="block lg:inline-block">
                    <svg className=" w-5 h-5  mx-auto stroke-current fill-current text-black lg:text-white " xmlns="http://www.w3.org/2000/svg" width="22.54" height="22.59" viewBox="0 0 22.54 22.59">
                  ...
                  <div className=" block lg:inline-block px-1 py-1 lg:px-3 text-xs sm:text-lg md:text-lg font-light">Setting</div>
                </a>
              </li>
